...
exe 'hi ErrorMsg     guifg=' . s:boldWhite . ' gui=underline' 
...
exe 'hi DiffText     cterm=bold guifg=' . s:boldWhite . ' gui=underline'
...
exe 'hi Error        guifg=' . s:boldWhite . ' gui=underline' 
exe 'hi Todo         guifg=bg guibg=' . s:boldGreen

let colors_name = "ansi_blows_fw"
