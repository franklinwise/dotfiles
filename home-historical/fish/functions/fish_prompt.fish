function fish_prompt --description "Write out the prompt"
    ...
    if test -z $__vcsystem
        ...
        switch $__vcsystem
            ...
            set -g __vcprompt (__fish_git_prompt "%s" | sed 's/ //')
    ...
    echo -n -s "$__vcprompt" " " "$__fish_prompt_userhost" "$__fish_prompt_virtualenv" "$__fish_prompt_cwd" (prompt_pwd) "$__fish_prompt_normal" "$__fish_prompt_char"
