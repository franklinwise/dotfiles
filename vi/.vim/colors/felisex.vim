...
let g:colors_name = "felisex"

hi Normal ctermbg=Black ctermfg=White cterm=NONE guibg=Black guifg=#eeeeee gui=none
...
if v:version >= 700
  ...
  if has("spell")
    hi SpellBad ctermbg=Black  cterm=undercurl guisp=Black gui=undercurl
    hi SpellCap ctermbg=Black ctermfg=Blue cterm=NONE guisp=Blue gui=undercurl
    hi SpellLocal ctermbg=Black ctermfg=DarkCyan cterm=NONE guisp=DarkCyan gui=undercurl
    hi SpellRare ctermbg=Black ctermfg=DarkMagenta cterm=NONE guisp=Magenta gui=undercurl
  endif
...
hi Comment ctermbg=bg ctermfg=DarkGreen guibg=bg guifg=#669F69 gui=none
hi link SpecialComment Comment

hi Character ctermbg=bg ctermfg=Cyan guibg=bg guifg=Cyan gui=none
hi Constant ctermbg=bg ctermfg=Red guibg=bg guifg=#FB2E2F gui=none
...
hi Function ctermbg=bg ctermfg=Blue guibg=bg guifg=#23A0E0 gui=bold

hi Statement ctermbg=bg ctermfg=Yellow guibg=bg guifg=#7E7BCA gui=none
...
"hi Type ctermbg=bg ctermfg=Green guibg=bg guifg=#C83C3C gui=none
hi Type ctermbg=bg ctermfg=Green guibg=bg guifg=#F25F4A gui=none
...
"hi Todo ctermbg=Yellow ctermfg=bg cterm=NONE guibg=#ff66cc guifg=bg gui=bold
hi Todo ctermbg=Yellow ctermfg=bg cterm=NONE guibg=Yellow guifg=bg gui=bold
